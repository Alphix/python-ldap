...
class LDAP:
    ...
    def search_ext(self, *args: Any, **kwargs: Any) -> Any: ...
    def set_option(self, *args: Any, **kwargs: Any) -> Any: ...
    def simple_bind(self, *args: Any, **kwargs: Any) -> Any: ...
    def start_tls_s(self, *args: Any, **kwargs: Any) -> Any: ...
    def unbind_ext(self, *args: Any, **kwargs: Any) -> Any: ...
    def whoami_s(
        self,
