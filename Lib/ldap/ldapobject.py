"""
ldapobject.py - wraps class ldap._ldap.LDAP
...
class SimpleLDAPObject:
  ...
  def cancel_s(
    ...
    serverctrls: Optional[List[RequestControl]] = None,
    clientctrls: Optional[List[RequestControl]] = None,
  ) -> Optional[Union[Tuple[int, Sequence[LDAPResult]], Tuple[None, None]]]:
  ...
  ) -> Union[Tuple[Optional[str], Optional[bytes]], "ldap.extop.ExtendedResponse"]:
  ...
  ) -> Tuple[Optional[str], Optional[Union[bytes, PasswordModifyResponse]]]:
  ...
  def result(
    ...
    all: int = 1,
    timeout: Optional[Union[int, float]] = None,
  ) -> Union[Tuple[int, Sequence[LDAPResult]], Tuple[None, None]]:
    """
  ...
  def result2(
    ...
    all: int = 1,
    timeout: Optional[Union[int, float]] = None,
  ) -> Union[Tuple[int, Sequence[LDAPResult], int], Tuple[None, None, None]]:
  ...
  def search_ext(
    ...
    base: str,
    scope: int,
    filterstr: Optional[str] = '(objectClass=*)',
  ...
  def get_option(
    self,
    option: int
  ) -> Union[bool, int, str, bytes, float, Dict[str, Union[int, str, Tuple[str, ...]]], List[ResponseControl]]:
    result = None
